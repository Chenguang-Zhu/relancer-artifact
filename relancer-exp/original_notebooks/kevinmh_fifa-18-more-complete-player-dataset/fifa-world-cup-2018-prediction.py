...
countries = pd.read_csv("../../../input/kevinmh_fifa-18-more-complete-player-dataset/complete.csv")
historical = pd.read_csv("../../../input/kevinmh_fifa-18-more-complete-player-dataset/complete.csv")
player_stats_18 = pd.read_csv("../../../input/kevinmh_fifa-18-more-complete-player-dataset/complete.csv")
results = pd.read_csv("../../../input/kevinmh_fifa-18-more-complete-player-dataset/complete.csv")
squads = pd.read_csv("../../../input/kevinmh_fifa-18-more-complete-player-dataset/complete.csv")
fifa18 = pd.read_csv("../../../input/kevinmh_fifa-18-more-complete-player-dataset/complete.csv")
results_so_far = pd.read_csv("../../../input/kevinmh_fifa-18-more-complete-player-dataset/complete.csv")
stats = pd.read_csv("../../../input/kevinmh_fifa-18-more-complete-player-dataset/complete.csv")
world_cup = pd.read_csv("../../../input/kevinmh_fifa-18-more-complete-player-dataset/complete.csv")
...
squads = pd.read_csv("../../../input/kevinmh_fifa-18-more-complete-player-dataset/complete.csv")
rankings = pd.read_csv("../../../input/kevinmh_fifa-18-more-complete-player-dataset/complete.csv")
